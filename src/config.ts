...
export const config = {
  ...
  products: [
    ...
    },
    {
      id: "kopriva-polen",
      name: {
        sr: "Med sa semenom koprive i polenom",
        en: "Honey with nettle seed and pollen",
      },
      note: {
        sr: "Obogaćen semenom koprive i polenom — prirodna snaga u svakoj kašičici.",
        en: "Enriched with nettle seed and pollen — natural strength in every spoonful.",
      },
      priceRsd: 1300,
      priceEur: 12,
      tag: { sr: "", en: "" },
      image: "/images/product-kopriva-polen.jpg",
      tone: "#9aa838",
    },
    {
      id: "krem-kakao-lesnik",
      name: {
        sr: "Krem med od kakaa i lešnika",
        en: "Cream honey with cocoa and hazelnut",
      },
      note: {
        sr: "Kremasta poslastica od kakaa i lešnika — omiljena kod dece i odraslih.",
        en: "A creamy treat of cocoa and hazelnut — loved by kids and adults alike.",
      },
      priceRsd: 1500,
      priceEur: 14,
      tag: { sr: "Premium", en: "Premium" },
      image: "/images/product-krem-kakao-lesnik.jpg",
      tone: "#5a3a1c",
    },
  ],
